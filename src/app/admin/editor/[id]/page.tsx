...
export default function EditorPage() {
  ...
  }, [title, slug, content, summary, categoryId, selectedTags, status, isTop, isEssence, isOutdated, aiSummary, coverImage, generateSlug, router]);
          ...
          <div className="rounded-xl p-4 space-y-3" style={{ background: c.card }}>
            ...
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => setIsTop(!isTop)}
                role="switch" aria-checked={isTop} aria-label="置顶"
            ...
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => setIsEssence(!isEssence)}
                role="switch" aria-checked={isEssence} aria-label="精选"
                className="w-9 h-5 rounded-full transition-colors relative"
            ...
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => setIsOutdated(!isOutdated)}
                role="switch" aria-checked={isOutdated} aria-label="过时提醒"
                className="w-9 h-5 rounded-full transition-colors relative"
